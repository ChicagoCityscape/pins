...
## Other info: Property classes and descriptions
...
## Other info: Township and township neighborhood boundaries
...
### Get the data
* [Download as a shapefile](). Projection is EPSG:3435, Illinois StatePlane East (feet)
* [Download as GeoJSON](). Projection is EPSG:4326, WGS84 mercator
